 ...
 * The instance of this class will mark every placeholder in the sql text, 
 * just like the client PreparedStatement of MySQL JDBC Driver.
 */
public class ProxyPreparedStatement implements PreparedStatement {
    ...
    private final Map<Integer, Integer> placeHolderIdx;
    ...
    protected ProxyPreparedStatement(final Connection connection, final String sql) {
        this(connection, sql, -1, -1, -1);
    }
    
    protected ProxyPreparedStatement(final Connection connection, final String sql, final int autoGeneratedKeys) {
        this(connection, sql);
        this.autoGeneratedKeys = autoGeneratedKeys;
    }
    
    protected ProxyPreparedStatement(final Connection connection, final String sql, final int resultSetType,
    ...
    protected ProxyPreparedStatement(final Connection connection, final String sql, final int resultSetType,
        ...
        this.placeHolderIdx = SqlStringUtils.parsePlaceholderIndex(sql);
